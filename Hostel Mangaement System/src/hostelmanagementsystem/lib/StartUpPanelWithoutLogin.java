      ...
      private boolean fadingTypeIN=true;
       public StartUpPanelWithoutLogin(int width,int height,float alpha){
           ...
           BufferedImage icon=null;
            ...
            customAreaPanel capAdminLogin=new customAreaPanel(190,50,icon,"Admin Login","System maintainance","capAdminLogin");
            add(capAdminLogin);
            ...
            customAreaPanel capAbout=new customAreaPanel(250,50,icon,"About","Why this system is ment for","capAbout");
            add(capAbout);
        ...
        private class mouseListener extends MouseAdapter{
            ...
            public void mouseClicked(MouseEvent mev){
                ...
                if(click){
                    if(listenerPanel.getID().equals("capLogin") || listenerPanel.getID().equals("capAdminLogin")){
