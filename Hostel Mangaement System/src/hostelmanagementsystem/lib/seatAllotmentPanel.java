...
public class seatAllotmentPanel extends JPanel{
    ...
    public seatAllotmentPanel(){
        ...
        String paramBatch[]={"Batch","2009-2013","2010-2014","2011-2015","2012-2016"};
        ...
        String paramStream[]={"Stream","AEIE","CSE","CIVIL","ECE","EE","IT","ME"};
        cbStream = new customComboBox(new Dimension(60,20),paramStream);
        add(cbStream);
        springLayout.putConstraint(SpringLayout.WEST,cbStream,13,SpringLayout.EAST,cbBatch);
        ...
        String paramHostel[]={"Hostel","1st","2nd","3rd","4th"};
    ...
    private void checkAllotment(customTextField fld){
       String alphaPattern="^[a-zA-Z]+$",numericPattern="^[0-9]+$";
       ...
       if(fld==roll || fld==null){
           if(roll.getText().matches(numericPattern)){ rollError=false;  fieldError=false; } else{ rollError=true;  fieldError=true; }
       }
