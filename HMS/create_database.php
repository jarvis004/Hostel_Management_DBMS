...
$demo_pass=hash('md4',"admiral");
$query='insert into student
         (username,password,pic_name,name,roll_no,email,address1,address2,city,pincode,batch,stream)
        values
          ("jeet1099","'.$demo_pass.'","NPP.png","Indrajeet Kumar Mishra","123456","demo@gmail.com","myplace","","Asansol","713301","2009-2013","CSE")';
mysql_query($query,$db) or die(mysql_error($db));
